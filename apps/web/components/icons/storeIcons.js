...
export const LocationIcon = createPublicIcon("icon-store-location-01");
export const LogOutIcon = createPublicIcon("icon-external");
...
export const SecureIcon = createPublicIcon("icon-shopping-basket-secure-01");
