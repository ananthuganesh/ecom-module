...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/admin/settings/payment", destination: "/admin/settings/integrations/payment", permanent: false },
      { source: "/admin/settings/payments", destination: "/admin/settings/integrations/payment", permanent: false },
      ...
      { source: "/admin/integrations/razorpay", destination: "/admin/settings/integrations/payment", permanent: false },
      ...
      { source: "/admin/settings/integrations/razorpay", destination: "/admin/settings/integrations/payment", permanent: false },
